<template>
    <div>
        <b-link id="view-band-btn" @click="toggleModal">
        ...
        <b-modal v-model="show" ref="band-modal" :title="'Details de la bande ' + item.label + ' - ' + item.id">
            <div class="d-block ">
                <ul id="example-1">
...
<script>
    export default {
        ...
        methods: {
            toggleModal() {
                this.$refs['band-modal'].toggle('#view-band-btn')
            }
        }
    }
</script>